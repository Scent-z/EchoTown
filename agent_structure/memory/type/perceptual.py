    ...
    def update(
        ...
        if content is not None or (metadata and "raw_data" in metadata):
            ...
            try:
                ...
                self.vector_store.add_vectors(  # 这行代码有问题, 没有self.vector_store, 应该像前面add一样, 找到对应模态的vector_store再更新
